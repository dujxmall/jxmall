				...
				<div>
					<div class="flex-y-center">
						<div class="flex-x-center" style="margin-right: 20px;border-radius: 4px;">
							<div style="width: 50px;height: 39px;border-top-left-radius: 3px;border-bottom-left-radius: 3px;"
								class="flex-y-center flex-x-center date-item"
								:class="{'date-active':select_date==1?true:false}" @click="dateClick(1)">日
							</div>
							<div style="width: 50px;height: 39px;border-right: none;border-left: none;"
								class="flex-y-center flex-x-center date-item" @click="dateClick(2)"
								:class="{'date-active':select_date==2?true:false}"
								:style="{'border-right':select_date==2?'solid #22A1FE 1px':'none','border-left':select_date==2?'solid #22A1FE 1px':'none'}">
								月
							</div>
							<div style="width: 50px;height: 39px;border-top-right-radius: 3px;border-bottom-right-radius: 3px;"
								class="flex-y-center flex-x-center date-item" @click="dateClick(3)"
								:class="{'date-active':select_date==3?true:false}">年
							</div>
						</div>
					...
					<el-table-column label="商品" width="300">
						<template slot-scope="scope">
							<div class="flex-y-center" style="color: #000000;">
								<div>
									<el-image style="width: 200px;" :src="scope.row.cover_pic" fit="fill"></el-image>
								</div>
								<div>
