          ...
          <el-form label-width="100px" style="width:800px">
                    ...
                    <div>
                      <div flex="main:center cross:center" class="add-image-btn flex-x-center flex-y-center"
                        ...
                        <span class="flex-x-center flex-y-center pic-del"> <i class="el-icon-close"
                                                                              @click="deleteImg('bg_pic')"></i></span>
                      </div>
                      <file-picker v-if="!form.bg_pic.url" style="margin-right: 5px;" v-model="form.bg_pic.url"
                                   width="88" height="88">
                        <div flex="main:center cross:center" class="add-image-btn flex-x-center flex-y-center">
            ...
            <el-form-item label="二维码">
              <div class="edit-nav-item flex-row flex-y-center" style="width: 100%;">
                ...
                <el-slider show-input style="width: 90%;" v-model="form.qr_code.size" :max="400" :min="0"
                           :step="1"></el-slider>
              </div>
              <div class="edit-nav-item flex-row flex-y-center" style="width: 100%;">
                <div>左：</div>
                <el-slider show-input style="width: 90%;" v-model="form.qr_code.left" :max="622" :min="0"
                           :step="1"></el-slider>
              </div>
              <div class="edit-nav-item flex-row flex-y-center" style="width: 100%;">
                <div>上：</div>
                <el-slider show-input style="width: 90%;" v-model="form.qr_code.top" :max="1222" :min="0"
                           :step="1"></el-slider>
              </div>
            </el-form-item>
            <el-form-item label="头像">
              ...
              <div class="edit-nav-item flex-row flex-y-center" style="width: 100%;">
                <div style="text-align: end;">大小：</div>
                <el-slider show-input style="width: 90%;" v-model="form.head.size" :max="200" :min="0"
                           :step="1"></el-slider>
              </div>

              <div class="edit-nav-item flex-row flex-y-center" style="width: 100%;">
                <div style="text-align: end;">左：</div>
                <el-slider show-input style="width: 90%;" v-model="form.head.left" :max="622" :min="0"
                           :step="1"></el-slider>
              </div>
              <div class="edit-nav-item flex-row flex-y-center" style="width: 100%;">
                <div>上：</div>
                <el-slider show-input style="width: 90%;" v-model="form.head.top" :max="1222" :min="0"
                           :step="1"></el-slider>
              </div>
            </el-form-item>
            <el-form-item label="昵称">
              <div class="edit-nav-item flex-row flex-y-center" style="width: 100%;height: 60px;">
                <div style="text-align: end;">是否显示：</div>
                <el-radio-group v-model="form.name.is_show">
                  <el-radio :label="0">不显示</el-radio>
                  <el-radio :label="1">显示</el-radio>
                </el-radio-group>
              </div>
              ...
              <div class="edit-nav-item flex-row flex-y-center" style="width: 100%;">
                <div>字号：</div>
                <el-slider show-input style="width: 90%;" v-model="form.name.font" :max="100" :min="0"
                           :step="1"></el-slider>
              </div>
              <div class="edit-nav-item flex-row flex-y-center" style="width: 100%;">
                <div>左：</div>
                <el-slider show-input style="width: 90%;" v-model="form.name.left" :max="622" :min="0"
                           :step="1"></el-slider>
              </div>
              <div class="edit-nav-item flex-row flex-y-center" style="width: 100%;">
                <div>上：</div>
                <el-slider show-input style="width: 90%;" v-model="form.name.top" :max="1222" :min="0"
                           :step="1"></el-slider>
              </div>
            </el-form-item>
          </el-form>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      name() {
        return `left:${this.form.name.left}px;top:${this.form.name.top}px;font-size:${this.form.name.font}px;color:${this.form.name.color};display:${this.form.name.is_show == 1 ? 'block' : 'none'}`
      }
    },
    created() {
      this.getSetting()
    ...
    methods: {
      ...
      linkSelected(e) {
        if (!this.form.tabbar.list[this.currentEditNavIndex].name || this.form.tabbar.list[this.currentEditNavIndex].name ==
          '') {
      ...
      menuLinkSelected(e) {
        if (!this.form.menus.list[this.currentMenuEditNavIndex].name || this.form.menus.list[this.currentMenuEditNavIndex].name ==
          '') {
