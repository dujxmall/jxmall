	...
	<div class="app-container">
			...
			<el-col :span="24" :xs="24">
				...
				<el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
					...
					<el-table-column label="手机号码" align="center" key="mobile" prop="mobile" v-if="columns[4].visible"
						width="120" />
					<el-table-column label="创建时间" align="center" prop="created_time" v-if="columns[6].visible"
						width="160">
		...
		<el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
			<el-form ref="form" :model="form" :rules="rules" label-width="80px">
				<el-row v-if="admin_type==0">
					<el-col :span="12">
						<el-form-item label="账户类型" prop="admin_type">
							<el-radio-group v-model="form.admin_type">
								<el-radio :label="2">员工</el-radio>
								<el-radio :label="1">子账户</el-radio>
							</el-radio-group>
						</el-form-item>
						</el-form-item>
					</el-col>
	...
	export default {
		...
		methods: {
			...
			handleDelete(row) {
				...
				this.$modal.confirm('是否确认删除用户编号为"' + user_id + '"的数据项？').then(function() {
