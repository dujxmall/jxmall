      ...
      <div class="content">
        ...
        <div class="scorll-div" style="overflow: auto;width: 100%;" v-if="data.type==1">
          <ul
            ...
            <li style="padding: 0;margin: 0" v-if="data.list.length" v-for="(goods,index) in data.list">
              <div class="goods-item" :style="goodsStyle">
                <div class="goods-item-box">
                  ...
                  <div style="padding: 5px;">
                    ...
                    <div class="sales" v-if="data.show_sales==1">
                      <span>{{data.sales_text}}</span> <span :style="{color:data.price_color}">100</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div v-if="data.list.length" v-for="(goods,index) in data.list" :style="goodsStyle">
            <div style="width: 100%;background-color: #FFF;border-bottom: solid #f0f0f0 1px;padding: 10px;">
              <div class="flex-y-center">
                ...
                <div style="position: relative;height: 100px;width:75%;">
                  <div class="goods-title">{{goods.name}}</div>
    ...
    <div class="diy-component-edit">
      <el-form label-width="100px">
        ...
        <el-form-item label="显示销量">
          <el-radio-group v-model="data.show_sales">
            <el-radio :label="0">不显示</el-radio>
            <el-radio :label="1">显示</el-radio>
          </el-radio-group>
        </el-form-item>
        <el-form-item label="销量文字">
          <el-input type="text" v-model="data.sales_text"></el-input>
        </el-form-item>
        ...
        <el-form-item label="选择商品">
          ...
          <div style="width: 100%;text-align: center;">
            <goods-picker @selected="selectedGoods" style="margin-right: 5px;" width="88" height="88">
              <el-button type="text">+添加商品({{data.list.length}}/50)</el-button>
            </goods-picker>
          </div>
        </el-form-item>
      </el-form>
