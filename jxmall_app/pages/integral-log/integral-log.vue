<template>
	<view>
		<tui-tabs :tabs="navbar" selectedColor="#EB0909" sliderBgColor="#EB0909" :currentTab="currentTab"
			@change="tabChange" itemWidth="33.333%"></tui-tabs>
	<view style="padding-top: 10rpx;">
		...
		<view v-if="list.length>0" v-for="item in list"
			...
			<view class="flex-x-between">
				<view style="color: #B3B3B3;font-size: 10pt;margin-top: 20rpx;">当前积分：{{item.current}}</view>
