<template>
	<tui-page>
		<view class="container">
			...
			<view class="right-box" v-if="second_list.length>0">
				<view class="page-view">
					<swiper indicator-dots autoplay circular :interval="5000" :duration="150" class="swiper">
						<swiper-item @tap.stop="detail(item)" v-for="(item, index) in second_list" v-if="second_list">
							<image :src="item.adv_pic" mode="aspectFill" class="slide-image" />
						</swiper-item>
					</swiper>
				</view>
			</view>
			<view class="right-box" v-else>
				<view class="page-view">
					<swiper indicator-dots autoplay circular :interval="5000" :duration="150" class="swiper">
						<swiper-item @tap.stop="detail(item)" v-for="(item, index) in list" v-if="list">
							<image :src="item.adv_pic" mode="aspectFill" class="slide-image" />
						</swiper-item>
					</swiper>
				</view>
			...
			<block v-for="(item, index) in second_list" :key="index">
				...
				<scroll-view scroll-y class="right-box" :style="{ height: height + 'px'}" style="top:320rpx"
						...
						<view class="class-box">
							<view class="class-item">
								...
								<view class="g-container">
									<view class="g-box" @tap.stop="detail(item)" data-key="高价回收"
										v-if="item.children.length" v-for="child in item.children">
