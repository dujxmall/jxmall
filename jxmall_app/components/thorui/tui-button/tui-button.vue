<template>
	<button class="tui-btn" :class="[
			plain ? 'tui-' + type + '-outline' : 'tui-btn-' + (type || ''),
		...
		:style="{ width: width, height: height, lineHeight: height, fontSize: size + 'rpx', margin: margin,backgroundColor:bgColor,color:color }"
...
<style lang="scss" scoped>
	...
	.tui-btn-danger {
		background: $uni-color-danger !important;
		color: #fff;
	}
