	 ...
	 :style="{
		...
		<view v-for="(item, index) in tabs" :key="index" class="tui-tabs-item" :style="{ width: itemWidth }" @tap.stop="swichTabs(index)">
			<view style="position: relative;">
				...
				<view style="width: 30rpx;height: 30rpx;background-color: #E5231D;border-radius: 50%;color: #FFFFFF;font-size: 8pt;position: absolute;left: -25rpx;top: -20rpx;"
				 class="flex-y-center flex-x-center" v-if="item.num">{{item.num}}</view>
			</view>
		</view>
