<template>
	...
	<block v-if="node.node == 'element'">
		...
		<view v-else-if="node.tag == 'p'" :class="node.classStr" :style="node.styleStr" style="font-size: 14px;color: #303030;line-height: 1.6;width: 100%;word-wrap: break-word;word-break: break-all;overflow: hidden;">
			<block v-for="(node, index) of node.nodes" :key="index">
				<wx-parse-template :node="node" />
			</block>
		</view>
