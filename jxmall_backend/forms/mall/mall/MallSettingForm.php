...
class MallSettingForm extends BaseModel
{
    ...
    public $is_must_parent_id;//下单必须要绑定推荐人
    ...
    public function rules()
    {
        return [
            ...
            [['over_time','is_must_parent_id', 'is_ban_cancel', 'is_show_add_cart', 'confirm_time', 'complete_time', 'is_binding', 'show_contact', 'show_phone', 'is_home_login', 'show_nav', 'is_login_mobile'], 'integer'],
