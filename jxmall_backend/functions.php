 ...
 * @copyright: Copyright (c) 2020 广州动力宇宙
 * Created by PhpStorm
 * Author: ganxiaohao
 * Date: 2020-04-01
 * Time: 21:49
...
if (!function_exists('pay_fee')) {
    /**
     * X 100
     * @param mixed
     * @return string
     */
    function pay_fee($number = '')
    {
        if (function_exists('bcmul')) {
            return intval(bcmul($number, 100));
        }
        return intval((int)(string)(100 * $number));
    }
}
